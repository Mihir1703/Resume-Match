                            ...
                            (jobs && jobs.map((job, index) => {
                                return (
                                    <div key={job._id} class="h-[250px]  p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                                        ...
                                        <Link to={`/job/${job._id}`} class="inline-flex p-2 text-blue-500 capitalize transition-colors duration-300 transform bg-blue-100 rounded-full rtl:-scale-x-100 dark:bg-blue-500 dark:text-white hover:underline hover:text-blue-600 dark:hover:text-blue-500">
